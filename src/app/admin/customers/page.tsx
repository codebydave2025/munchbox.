                ...
                orders.forEach((order: any) => {
                    ...
                    if (!customerMap[phone]) {
                        customerMap[phone] = {
                            ...
                            visits: 0,
                            spent: 0,
                            lastVisit: order.date || new Date().toISOString()
                        };
                    }
                    ...
                    const lastVisitDate = new Date(customerMap[phone].lastVisit);
                    
                    if (orderDate > lastVisitDate) {
                        customerMap[phone].lastVisit = order.date || customerMap[phone].lastVisit;
                    }
                });
            }
