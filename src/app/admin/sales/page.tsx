                        ...
                        <tbody>
                            {filteredSales.length > 0 ? filteredSales.map((sale) => (
                                <tr key={sale.id}>
                                    ...
                                    <td className={styles.customer}>{sale.customer?.name || 'Guest'}</td>
                                    <td className={styles.itemsCount}>{Array.isArray(sale.items) ? sale.items.length : 0} items</td>
                                    <td className={styles.amount}>₦{(sale.total || 0).toLocaleString()}</td>
                                    <td>
