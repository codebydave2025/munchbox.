              ...
              <div className={styles.section}>
                ...
                <div className={styles.customerInfo}>
                  <div className={styles.infoLine}>
                    <User size={14} /> <strong>{order.customer?.name || 'Guest'}</strong>
                  </div>
                  <div className={styles.infoLine}>
                    <Phone size={14} /> <span>{order.customer?.phone || 'N/A'}</span>
                  </div>
                  <div className={styles.infoLine}>
                    <MapPin size={14} /> <span>{order.customer?.address || 'N/A'}</span>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.section}>
                ...
                <div className={styles.itemsList}>
                  {Array.isArray(order.items) ? order.items.map((item, idx) => (
                    ...
                    <p style={{ fontSize: '0.8rem', color: '#888' }}>No items in this order</p>
                  )}
